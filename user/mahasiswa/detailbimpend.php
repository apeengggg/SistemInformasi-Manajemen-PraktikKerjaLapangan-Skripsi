  ...
  $getbim = mysqli_query($conn, "SELECT * FROM skripsi_bim WHERE nim='$nim' AND status='Bimbingan Pendadaran'") or die (mysqli_erorr($conn));
  ...
  dp.penguji='$decode' AND bim.status='Bimbingan Pendadaran' 
  ...
  FROM draft_penguji dp
  LEFT JOIN draft_sidang ds
  ON dp.id_sidang=ds.id_sidang
  LEFT JOIN skripsi 
  ON ds.id_skripsi=skripsi.id_skripsi
  LEFT JOIN proposal 
  ON skripsi.id_proposal=proposal.id_proposal
  LEFT JOIN judul 
  ON proposal.id_judul=judul.id_judul
  ...
  LEFT JOIN dosen d1 
  ON dp.penguji=d1.nidn
  WHERE mahasiswa.nim='$nim' AND dp.penguji='$decode'") or die (mysqli_erorr($conn));
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-12">
              <a href="bimbinganpendadaran.php" class="btn btn-warning">Kembali</a>
            ...
            -->
                                  ...
                                  <div class="form-row">
                                    ...
                                    <div class="form-group col-md-4>
                                      <label for="nama">Nama</label>                                    <input type="text" class="form-control" id="nama" name="nama" disabled>
                                  </div>
