...
$pathlemrev= '../../assets/persyaratan_pkl/'.$newfile;
$cekstatusx1 = mysqli_query($conn, "SELECT * FROM pkl_syarat WHERE nim='$nim' AND 
...
if (mysqli_num_rows($cekstatusx1)>0) {
  ...
  windows.location.href='validasipkl.php'
  </script>"; 
}else{
...
$insertlem = mysqli_query($conn, "INSERT INTO pkl_syarat 
                                  (file, nim) 
...
$newfile =  $nim.'-'.$namefile.'-'.$file;
$pathlemrev= '../../assets/persyaratan_pkl/'.$newfile;
$cekstatusx = mysqli_query($conn, "SELECT status FROM pkl_syarat WHERE id_syarat='$id'");
...
$file_tmp = $_FILES["file"]["tmp_name"];
unlink('../../assets/persyaratan_pkl/'.$file_lama);
if (move_uploaded_file($file_tmp, $pathlemrev)) {
$insertlem = mysqli_query($conn, "UPDATE pkl_syarat 
                                  SET file='$newfile' 
...
<head>
  ...
  <title>Validasi Persyaratan Praktik Kerja Lapangan | SIM-PS | Mahasiswa</title>
      ...
      <div class="col-12">
        <div class="card">
          <div class="card-header">
            <center>
              <h3 class="m-0 text-dark">Validasi Persyaratan Praktik Kerja Lapangan</h3>
            </center>
          </div>
          <div class="card-header">
          ...
          <div class="card-body">
            ...
            <table id="example1" class="table table-bordered table-striped">
              ...
              <tbody>
                ...
                <tr>
                  <td><?= $tgl  ?></td>
                  <td align="center"><a href="assets/downsyaratpkl.php?filename=<?= $data["file"] ?>"
            ...
            <div class="card-body">
              <div class="form-group row">
                ...
                <div class="col-sm-9">
                  ...
                  <small id="emailHelp" class="form-text text-muted">File Persyaratan Harus Ber-Ekstensi PDF, Maximal
                    Size 250 KB</small>
                </div>
              </div>
            </div>
          ...
          <form action="" method="post" enctype="multipart/form-data">
            ...
            <div class="form-row">
              <div class="form-group col-md-12">
                ...
                <br><small><b>PDF, Max Size 250 KB</b></small>
              </div>
            </div>
            <!-- /.card-body -->
            <div class="modal-footer justify-content-between">
