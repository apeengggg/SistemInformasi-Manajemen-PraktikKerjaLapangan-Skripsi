...
//ambil data user
$get = mysqli_query($conn, "SELECT * FROM mahasiswa WHERE nim='$nimm'") or die (mysqli_error($conn));
...
if (isset($_POST["ubahdata"])) {
  ...
  if (empty($foto)) {
    ...
    alamat_rumah='$alamat',
    no_hp ='$hp'
    WHERE nim='$nimm'") or die (mysqli_error($edit));
    if ($edit) {
      echo "<script>
    ...
    if (in_array($eks, $ekstensi)) {
      if ($ukuran > 100000) {
        ...
        if (move_uploaded_file($tmp_foto, $pathfoto)) {
          ...
          alamat_rumah='$alamat',
          no_hp ='$hp'
          WHERE nim='$nimm'") or die (mysqli_error($edit1));
          if ($edit1) {
            echo "<script>
      ...
      echo "<script>
      alert('File Yang Diizinkan hanya jpg, jpeg, png')
      window.location.href('datauser.php')
      </script>"; 
    }
  }
...
if (isset($_POST["ubahpassword"])) {
  ...
  if ($password_lama != $p2) {
    ...
    if ($password_baru != $ulangi) {
      ...
      $ubahpassword=mysqli_query($conn, "UPDATE mahasiswa SET password='$p3' WHERE nim='$nim'") or die (mysqli_erorr($conn));
      if ($ubahpassword) {
        echo "<script>
...
<head>
  ...
  <title>SIM-PS | Data User | Mahasiswa</title>
          ...
          <form class="form-horizontal" method="post" enctype="multipart/form-data">
            <div class="card-body">
              <div class="form-group row">
                <div class="col-sm-10">
                  <center>
                    <img src="../../assets/foto/<?= $data["foto"] ?>" alt="" width="140px" height="150px">
                  </center>
                </div>
              </div>
              <div class="form-group row">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-10">
                  ...
                  <br>
                  <small><b>jpg, jpeg, dan png, maximal 100 KB</b></small>
                </div>
              </div>
              <div class="form-group row">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-10">
                  <input type="text" class="form-control" id="alamat_rumah" name="alamat_rumah"
                    value="<?php echo $data["alamat_rumah"]?>" required="required">
                </div>
              </div>
              <div class="form-group row">
      ...
      <section class="col-lg-5 connectedSortable">
        <div class="card card-info">
          ...
          <form class="form-horizontal" method="post">
            <div class="card-body">
              <div class="form-group row">
                <label for="status_pkl" class="col-sm-4 col-form-label">PKL</label>
                <div class="col-sm-5">
                  <input type="text" class="form-control" name="status_pkl" id="status_pkl" placeholder="status_pkl"
                    value="<?php echo $data["status_pkl"] ?> " disabled>
                </div>
              </div>
              <div class="form-group row">
                <label for="status_proposal" class="col-sm-4 col-form-label">Proposal</label>
                <div class="col-sm-5">
                  <input type="text" class="form-control" id="status_proposal" placeholder="status_proposal"
                    name="status_proposal" value=" <?php  echo $data["status_proposal"] ?> " disabled>
                </div>
              </div>
              <div class="form-group row">
                <label for="status_draft" class="col-sm-4 col-form-label">Skripsi</label>
                <div class="col-sm-5">
                  <input type="text" class="form-control" id="status_draft" placeholder="status_draft"
                    name="status_draft" value=" <?php  echo $data["status_skripsi"] ?> " disabled>
                </div>
              </div>
            </div>
        </div>
          ...
          <form class="form-horizontal" method="post">
            <div class="card-body">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-5">
                  <input type="password" class="form-control" id="password_baru" placeholder="password_baru"
                    name="password_baru">
                </div>
              </div>
              <div class="form-group row">
