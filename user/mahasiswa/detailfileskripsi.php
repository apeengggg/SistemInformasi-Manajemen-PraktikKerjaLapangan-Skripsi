...
"SELECT 
m.nim, m.nama, m.foto, j.judul, 
-- pem1
(SELECT d.nama_dosen FROM dosen d INNER JOIN skripsi_dosbing sd 
ON d.nidn=sd.nidn WHERE sd.id_skripsi=s.id_skripsi AND sd.status_dosbing='Pembimbing 1'
AND sd.status='Aktif' LIMIT 0,1 ) AS pem1,
-- pem2
(SELECT d.nama_dosen FROM dosen d INNER JOIN skripsi_dosbing sd 
ON d.nidn=sd.nidn WHERE sd.id_skripsi=s.id_skripsi AND sd.status_dosbing='Pembimbing 2'
          ...
          <section class="content">
            <div class="row">
                ...
                <div class="card">
                  ...
                  <div class="card-body">
                    <table align="center">
                      ...
                      <tr>
                        <td><font size="4">Pembimbing1</font></td>
                        <td><font size="4">:</font></td>
                        <td><font size="4"><?= $data1["pem1"] ?></font></td>
                      </tr>
                      <tr>
                      <td colspan="4"><hr></td>
                      </tr>
                      <tr>
                        <td><font size="4">Pembimbing2</font></td>
                        <td><font size="4">:</font></td>
                        <td><font size="4"><?= $data1["pem2"] ?></font></td>
                      </tr>
                      <tr>
                      <td colspan="4"><hr></td>
                      </tr>
              ...
              <div class="col-12">
                ...
                <center> <h3 class="m-0 text-dark">Detail File Skripsi</h3></center></div>
                  <!-- /.card-header -->
                  <div class="card-body">
                  <!-- <object data="../../assets/laporan_pkl/<?=$data1["filePKL"]?>" type="application/pdf"
                  width="100" height="500"></object> -->
                  <embed src="../../assets/skripsi_jurnal_pdf/<?=$data1["jurnal_pdf"]?>" type="application/pdf" width="100%" height="500"></embed>
                  </div>
                 <!-- /.card-body -->
                 </div>
                 <!-- /.card -->
