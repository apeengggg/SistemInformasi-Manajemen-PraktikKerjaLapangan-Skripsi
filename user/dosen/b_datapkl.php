...
<head>
  ...
  <title>Data Praktik Kerja Lapangan | SIM-PS | Dosen</title>
        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header">
              <center>
                <h1 class="m-0 text-dark" id="bim">Data Praktik Kerja Lapangan Mahasiswa Bimbingan</h1><br>
              </center>
              ...
              <!-- <a href="#all" class="btn btn-primary">Semua Data</a> -->
            </div>
            <!-- /.card-header -->
            <div class="card-body">
  ...
  while ($data1=mysqli_fetch_array($datapkl) ) {
    ?>
                  ...
                  <tr>
                    ...
                    <td><a href="assets/downloadsurat.php?filename=<?=$data1["surat_balasan"]?>">Unduh</a></td>
                    <!-- <td>
