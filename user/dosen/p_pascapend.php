...
<head>
  ...
  <title>Bimbingan Pasca | SIM-PS | Dosen</title>
      ...
      <div class="col-12">
        <div class="card">
          <div class="card-header">
            <center>
              <h1 class="m-0 text-dark">Data Bimbingan Pasca Belum Dibalas</h1>
            </center>
          </div>
          <!-- /.card-header -->
          <div class="card-body">
            <table id="example1" class="table table-bordered table-striped">
              ...
              <tbody>
                <?php
                        ...
                        judul.judul AS judul, s.lem_rev_pend,
                        ...
                        WHERE bim.pembimbing='$nidn'AND bim.status='Bimbingan Pasca' AND bim.status_dosbing='Belum Dibaca'") or die (mysqli_erorr($conn));
                ...
                <tr>
                  <td><a href="detailbimpasca.php?id=<?= $idbimprop?>"><?= $data['nama'] ?></a></td>
                  <td><?= $data['pem1'] ?></td>
                  <td><?= $data['pem2'] ?></td>
                  <td><?= $data['judul']?></td>
                  <td align="center">
                  ...
                  <td align="center">
                    <button type="submit" class="btn-sm btn-dark" name="detail" data-toggle="modal"
                      ...
                      data-lemrev="<?php echo $data["lem_rev_pend"]?>" data-pem1="<?php echo $data["pem1"]?>"
            ...
            <table id="example3" class="table table-bordered table-striped">
              ...
              <tbody>
                <?php
                        ...
                        LEFT JOIN mahasiswa mhs
                        ON judul.nim=mhs.nim
                        WHERE bim.pembimbing='$nidn'AND bim.status='Bimbingan Pasca' GROUP BY mhs.nim") or die (mysqli_erorr($conn));
                ...
                <tr>
                  <td><?= $data1['nim'] ?></td>
                  <td><a href="detailbimpasca.php?id=<?= $idbimprop1?>"><?= $data1['nama'] ?></a></td>
                  <td><?= $data1['pem1'] ?></td>
                  <td><?= $data1['pem2'] ?></td>
                  <td><?= $data1['judul']?></td>
                </tr>
...
<script type="text/javascript">
  ...
  $(document).on("click", "#detaildata", function () {
    ...
    $("#modal-lg #lemrev").attr("href", "assets/downloadlemrevpend.php?filename=" + lemrev);
