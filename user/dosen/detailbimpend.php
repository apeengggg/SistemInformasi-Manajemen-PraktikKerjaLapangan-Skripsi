...
judul.judul AS judul, s.lem_rev_draft AS lem_rev, s.lem_rev_pend AS lem_rev1,
...
WHERE bim.pembimbing='$nidn' AND ds.tgl_sidang IS NOT NULL AND bim.status='Bimbingan Pendadaran' AND bim.nim='$decode' ORDER BY bim.tgl_bim DESC") or die (mysqli_erorr($conn));
...
LEFT JOIN mahasiswa mhs
ON judul.nim=mhs.nim
WHERE bim.pembimbing='$nidn'AND ds.tgl_sidang IS NOT NULL AND bim.status='Bimbingan Pendadaran' AND bim.nim='$decode' ORDER BY bim.tgl_bim ASC") or die (mysqli_erorr($conn));
...
if (isset($_POST["ubahbim"])) {
  ...
  if (empty($filebim)) {
    ...
    if ($sql) {
      ...
      windows.location.href='detailbimpend.php'
      </script>";
    }else {
      echo "<script>
...
<head>
  ...
  <title>Detail Bimbingan Pendadaran | SIM-PS</title>
      ...
      <div class="col-12">
        <div class="card">
          <div class="card-header">
            <center>
              <h2 class="m-0 text-dark">Data Bimbingan Pendadaran,
                <?=$data1["nama"] ?></h2>
            </center>
          </div>
          <!-- /.card-header -->
  ...
  while ($data=mysqli_fetch_array($getdata)) {
    ...
    ?>
                <tr>
                  ...
                  <td align="center"><a href="assets/downloadbimpend.php?filename=<?= $data['filebim'] ?>"
                ...
                ?>
                  ...
                  <td align="center">
                    <button type="submit" class="btn-xs btn-dark" name="detail" data-toggle="modal"
                      ...
                      data-lemrev1="<?php echo $data["lem_rev1"]?>" data-pem1="<?php echo $data["pem1"]?>"
                  ...
                  <div class="modal-body">
                    ...
                    <form action="" method="post" enctype="multipart/form-data">
                      ...
                      <div class="form-row">
                        ...
                        <div class="form-group col-md-3">
                          <label for="lemrev">Lembar Revisi Draft</label>
                          <br>
...
<script type="text/javascript">
  ...
  $(document).on("click", "#detaildata", function () {
    ...
    $("#modal-lg #lemrev1").attr("href", "assets/downloadlemrevpend.php?filename=" + lemrev1);
    $("#modal-lg #filebim").attr("href", "assets/downloadbimpend.php?filename=" + filebim);
    $("#modal-lg #file_hasilbim").attr("href", "assets/downloadhasilbimpend.php?filename=" + hasilbim);
  ...
  $(document).on("click", "#detaildata1", function () {
    ...
    $("#modal-lg1 #lemrev").attr("href", "assets/downloadlemrevdraft.php?filename=" + lemrev);
    $("#modal-lg1 #lemrev1").attr("href", "assets/downloadlemrevpend.php?filename=" + lemrev1);
    $("#modal-lg1 #filebim").attr("href", "assets/downloadbimpend.php?filename=" + filebim);
    $("#modal-lg1 #file_hasilbim").attr("href", "assets/downloadhasilbimpend.php?filename=" + hasilbim);
