...
<head>
  ...
  <title>Data File Proposal | SIM-PS | Dosen</title>
      ...
      <div class="col-12">
        <div class="card">
          <div class="card-header">
            <center>
              <h1 class="m-0 text-dark" id="all">Data File Proposal Mahasiswa Bimbingan</h1>
            </center>
            <!-- <a href="#bim" class="btn btn-primary">Data File Proposal Mahasisw Bimbingan</a> -->
          </div>
          <!-- /.card-header -->
          <div class="card-body">
            <table id="example3" class="table table-bordered table-striped">
              <thead align="center">
                <tr>
                  ...
                  <th width="300px">Judul Laporan</th>
                  <th width="300px">Studi Kasus</th>
              ...
              <tbody>
                <?php
                        ...
                        judul.judul,
                        judul.studi_kasus,
                        proposal_file.file, proposal_file.id_file
                        FROM proposal_file LEFT JOIN proposal
                        ...
                        WHERE judul.status_judul='Disetujui' AND proposal.dosbing='$nidn'")
                ...
                <tr>
                  ...
                  <td><a href="detailfileprop.php?id=<?=$ni?>"><?php echo $data1["judul"] ?></a></td>
                  <td><?php echo $data1["studi_kasus"] ?></td>
                  <td align="center"><a href="assets/downloadfileprop.php?filename=<?=$data1["file"]?>"
    ...
    <div class="row">
      <div class="col-12">
        <div class="card">
          <div class="card-header">
            <center>
              <h1 class="m-0 text-dark" id="all">Data File Proposal Mahasiswa</h1>
            </center>
            <!-- <a href="#bim" class="btn btn-primary">Data File Proposal Mahasisw Bimbingan</a> -->
          </div>
          <!-- /.card-header -->
            ...
            <table id="example1" class="table table-bordered table-striped">
              ...
              <tbody>
                <?php
                        ...
                        judul.judul,
                        judul.studi_kasus,
                        proposal_file.file, proposal_file.id_file, dosen.nama_dosen
                        FROM proposal_file LEFT JOIN proposal
                        ON proposal_file.id_proposal=proposal.id_proposal
                        LEFT JOIN judul
                        ON proposal.id_judul=judul.id_judul
