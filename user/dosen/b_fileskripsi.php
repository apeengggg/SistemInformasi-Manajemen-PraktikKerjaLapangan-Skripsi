...
<head>
  ...
  <title>Data File Skripsi | SIM-PS | Dosen</title>
  ...
  <section class="content">
      ...
      <div class="col-12">
        <div class="card">
          <div class="card-header">
            <center>
              <h1 class="m-0 text-dark" id="all">Data File Skripsi</h1><br>
            </center>
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-12">
            <!-- <h1 class="m-0 text-dark" id="bim">Data File Proposal Mahasiswa Bimbingan</h1> -->
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    </section>
    <div class="row">
      <div class="col-12">
        <div class="card">
          ...
          <div class="card-header">
            <center>
              <h1 class="m-0 text-dark" id="bim">Data File Skripsi Mahasiswa Bimbingan</h1><br>
            </center>
