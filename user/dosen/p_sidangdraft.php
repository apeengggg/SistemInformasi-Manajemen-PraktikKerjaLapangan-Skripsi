...
$jadwalsidang = mysqli_query($conn,
                        ...
                        ON ds.tgl_sidang IS NOT NULL AND ds.status_sidang IS NULL
                        WHERE dp.penguji='$nidn' AND ds.tgl_sidang='$date' ORDER BY ds.tgl_sidang DESC") 
...
$jadwalsidang1 = mysqli_query($conn,
                        ...
                        LEFT JOIN draft_penguji dp
                        ON ds.id_sidang=dp.id_sidang
                        WHERE dp.penguji='$nidn' GROUP BY mhs.nim") 
                        or die (mysqli_error($conn));
...
//   $ap = $_POST["aplikasi"];
//   // var_dump($_POST); die;
//   $send = mysqli_query($conn, "UPDATE draft_nilai SET peng1_pen='$npm1', peng1_peng='$npm2', 
...
//   windows.location.href='p_sidangdraft.php'
//   </script>";
//   }else {
//   echo "<script>
...
//   $ap = $_POST["aplikasi"];
//   // var_dump($_POST); die;
//   $send = mysqli_query($conn, "UPDATE draft_nilai SET peng2_pen='$npm1', peng2_peng='$npm2', 
...
<head>
  ...
  <title>Data Sidang Draft | SIM-PS | Dosen</title>
      ...
      <div class="col-12">
        <div class="card">
          <div class="card-header">
            <center>
              <h1 class="m-0 text-dark" id="penguji">Jadwal Pengujian Sidang Draft</h1><br>
            </center>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <!-- <td align="center">
                    <?php
                          $id = $data1["id_sidang"];
                          $sql = mysqli_query($conn, "SELECT * FROM draft_nilai WHERE id_sidang='$id' AND 
    ...
    <div class="row">
      <div class="col-12">
        <div class="card">
          <div class="card-header">
            <center>
              <h1 class="m-0 text-dark" id="penguji">Riwayat Pengujian Sidang Draft</h1><br>
            </center>
