...
$sql = mysqli_query($conn, "SELECT DISTINCT 
                            ...
                            LEFT JOIN judul ON 
                            proposal.id_judul=judul.id_judul
                            LEFT JOIN mahasiswa ON
                            judul.nim=mahasiswa.nim
                            WHERE mahasiswa.angkatan='$angkatan' AND sd.nidn='$nidn' AND sd.status='Aktif'
...
<table align="center">
<tr>
<td align="center" colspan="3"><h3>LAPORAN SKRIPSI MAHASISWA BIMBINGAN</h3></td>
</tr>
<tr>
...
$mpdf->WriteHTML($data);
$mpdf->Output('laporan-data-skrpisi.pdf', 'I');
}
?>