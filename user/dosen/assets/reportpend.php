...
$sql = mysqli_query($conn, "SELECT DISTINCT
                            ...
                            WHERE ppe.penguji='$nidn' AND mahasiswa.angkatan='$angkatan'
                            ORDER BY ps.tgl_sidang ASC") or die
                            (mysqli_erorr($conn));
...
<table align="center">
<tr>
<td align="center" colspan="3"><h3>LAPORAN PENGUJIAN SIDANG PENDADARAN MAHASISWA</h3></td>
</tr>
<tr>
