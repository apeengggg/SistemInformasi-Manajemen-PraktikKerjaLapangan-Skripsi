...
$sql = mysqli_query($conn, "SELECT mahasiswa.nim, mahasiswa.nama, mahasiswa.status_proposal AS status,
                            judul.judul, d.nama_dosen AS pem, d.nidn, proposal.id_proposal AS id
                            ...
                            WHERE mahasiswa.angkatan='$angkatan' AND d.nidn='$nidn'
...
<table align="center">
<tr>
<td align="center" colspan="3"><h3>LAPORAN PROPOSAL MAHASISWA BIMBINGAN</h3></td>
</tr>
<tr>
