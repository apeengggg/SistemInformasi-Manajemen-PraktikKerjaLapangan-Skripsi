...
saran='$pesan',
status_bim='$status',
status_dosbing='$read', status_mhs='$n'
...
<head>
  ...
  <title>Pasca Sidang Proposal | SIM-PS | Dosen</title>
      ...
      <div class="col-12">
        <div class="card">
          <div class="card-header">
            <center>
              <h1 class="m-0 text-dark">Data Bimbingan Pasca Sidang Proposal Belum Dibalas</h1>
            </center>
          </div>
          <!-- /.card-header -->
          <div class="card-body">
            <table id="example1" class="table table-bordered table-striped">
              ...
              <tbody>
                <?php
                        ...
                        WHERE bim.pembimbing='$nidn'AND bim.status='Bimbingan Pasca' 
                        AND bim.status_dosbing='Belum Dibaca'
                        ORDER BY bim.tgl_bim DESC") or die (mysqli_erorr($conn));
          ...
          <div class="modal-dialog modal-xl" role="document">
            <div class="modal-content">
              <div class="modal-header">
                ...
                <h5 class="modal-title" id="exampleModalLabel">Detail Bimbingan Pasca Sidang Proposal</h5>
          ...
          <div class="card-body">
            <table id="example3" class="table table-bordered table-striped">
              ...
              <tbody>
                ...
                <tr>
                  <td><?= $data1['nim'] ?></td>
                  <td><a href="detailpascabimprop.php?id=<?= $idbimprop1?>"><?= $data1['nama'] ?></a></td>
                  <td><?= $data1['pembimbing'] ?></td>
                  <td><?= $data1['judul']?></td>
                </tr>
                <?php }
                              }
...
<script type="text/javascript">
  ...
  $(document).on("click", "#detaildata", function () {
    ...
    $("#modal-lg #lem_rev").attr("href", "assets/downloadlemrevprop.php?filename=" + lemrev);
    $("#modal-lg #filebim").attr("href", "assets/downloadbimprop.php?filename=" + filebim);
    $("#modal-lg #file_hasilbim").attr("href", "downloadhasilbimprop.php?filename=" + hasilbim);
