...
<head>
  ...
  <title>Penjadwalan Sidang Pendadaran | SIM-PS | Tata Usaha</title>
            ...
            <table id="example1" class="table table-bordered table-striped">
              ...
              <tbody>
                <?php
                        ...
                        WHERE (ps.val_dosbing1='2' OR ps.val_dosbing2='2' ) 
                ...
                <tr>
                  ...
                  <td>
                    <button type="submit" id="detaildata" class="btn btn-warning" data-toggle="modal"
                      ...
                      data-peng2="<?php echo $data1["draft2"] ?>" data-tgl="<?php echo $data1["tgl_sid"] ?>"
