...
$nim = $_POST["nim1"];
if (!filter_var($nim, FILTER_VALIDATE_INT) === TRUE) {
  echo "<script>
alert('NIM bukan Angka! Gagal Menambahkan Mahasiswa!')
...
$unim = $_POST["nim"];
if (!filter_var($unim, FILTER_VALIDATE_INT) === TRUE) {
  echo "<script>
alert('NIM bukan Angka! Gagal Menambahkan Mahasiswa!')
windows.location.href('datamahasiswa.php')
</script>"; 
...
<head>
  ...
  <title>SIM-PS | Data Mahasiswa | Tata Usaha </title>
        ...
        <div class="card">
          <div class="card-header">
            ...
            <button type="submit" class="btn btn-primary" data-toggle="modal" data-target="#modal-md"><i
                class="fas fa-user-plus"></i> Tambah Data Mahasiswa</button>
            ...
            <table id="example3" class="table table-bordered table-striped">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td width="30px">
                    <button type="submit" id="detaildata" class="btn-xs btn-dark" data-toggle="modal"
                      data-target="#modal-xl" data-nim="<?= $data['nim']; ?>" data-nama="<?= $data['nama']; ?>"
                      data-password="<?= $pas ?>" data-foto="<?= $data['foto']; ?>"
                      data-alamat="<?= $data['alamat_rumah']; ?>" data-hp="<?= $data['no_hp']; ?>"
                      data-prodi="<?= $data['prodi']; ?>" data-ttl="<?= $data['ttl']; ?>"
                      data-akun="<?= $data['status_mhs']; ?>" data-pkl="<?= $data['status_pkl']; ?>"
                      data-proposal="<?= $data['status_proposal']; ?>" data-skripsi="<?= $data['status_skripsi']; ?>"><i
                        class="fas fa-info-circle"></i></button>
                    <a href="javascript:hapusData(<?=$data['nim']?>)" class="btn-xs btn-danger"><i
                    ...
                    <form class="form-horizontal" method="post">
                      <div class="card-body">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input type="text" class="form-control" id="nim1" name="nim1" placeholder="NIM"
                              maxlength="9" minlength="9" required="required">
                          </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input type="text" class="form-control" id="prodi1" name="prodi1"
                              placeholder="Program Studi" required="required" value="Teknik Informatika" readonly>
                          </div>
                        </div>
                        <div class="form-group row">
                    ...
                    <form action="" method="post">
                      <div class="form-row">
                        <div class="form-group col-md-4">
                          ...
                          <input type="text" class="form-control" id="nim" name="nim" required maxlength="9" minlength="9">
                        </div>
                        <div class="form-group col-md-4">
                      ...
                      <div class="form-row">
                        <div class="form-group col-md-4">
                          ...
                          <input type="prodi" class="form-control" id="prodi" name="prodi" readonly>
                        </div>
                        <div class="form-group col-md-4">
                      ...
                      <div class="form-row">
                        ...
                        <div class="form-group col-md-3">
                          ...
                          <input type="text" class="form-control" id="pkl" name="pkl" readonly>
                        </div>
                        <div class="form-group col-md-3">
                          <label for="proposal">Status Proposal</label>
                          <input type="text" class="form-control" id="proposal" name="proposal" readonly>
                        </div>
                        <div class="form-group col-md-3">
                          <label for="skripsi">Status Skripsi</label>
                          <input type="text" class="form-control" id="skripsi" name="pkl" readonly>
                        </div>
                      </div>
                      <!-- /.card-body -->
                      <div class="modal-footer justify-content-between">
...
<script type="text/javascript">
  ...
  $(document).on("click", "#detaildata", function () {
    ...
    $(".modal-body #pkl").val(pkl);
    $(".modal-body #proposal").val(proposal);
    $(".modal-body #skripsi").val(skripsi);
  });
  // cek show password
  $(document).ready(function () {
...
<script language="JavaScript" type="text/javascript">
  function hapusData(nim) {
    if (confirm("Menghapus data mahasiswa akan menghapus seluruh data mahasiswa tersebut (pkl, proposal, dan skripsi) Apakah anda yakin akan menghapus data ini?")) {
