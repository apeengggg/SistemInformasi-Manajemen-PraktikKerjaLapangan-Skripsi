...
windows.location.href('pendaftarsidangpkl.php')
</script>";
}else{
...
<head>
  ...
  <title>Penjadwalana Sidang PKL | SIM-PS | Tata Usaha</title>
                      ...
                      <div class="form-group row">
                        <div class="col-sm-9">
                          <input type="text" class="form-control" id="id_sidpkl" name="id_sidpkl" required="required"
                            readonly hidden>
                          <input type="text" class="form-control" id="idpkl" name="idpkl" required="required" readonly
                            hidden>
                        </div>
                      </div>
                      <div class="form-group row">
