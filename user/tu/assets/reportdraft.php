    ...
    $sql = mysqli_query($conn, "SELECT DISTINCT
        ...
        $sql = mysqli_query($conn, "SELECT DISTINCT
            ...
            $sql = mysqli_query($conn, "SELECT DISTINCT
                ...
                ON ds.id_sidang=dp.id_sidang
                WHERE mahasiswa.angkatan='$angkatan' AND 
                (ds.tgl_sidang BETWEEN '$tgl_awal' AND'$tgl_akhir') 
                ORDER BY mahasiswa.nim ASC") or die (mysqli_erorr($conn));
...
<head>
  ...
  <title>Laporan Sidang Draft</title>
</head>
...
<table align="center">
<tr>
<td align="center" colspan="3"><h3>LAPORAN SIDANG DRAFT MAHASISWA</h3></td>
</tr>
<tr>
