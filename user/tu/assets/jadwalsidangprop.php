...
$excel->getProperties()->setCreator('Admin')
             ...
             ->setTitle("Jadwal Sidang Proposal")
             ->setSubject("SidangProposal")
             ->setDescription("Jadwal Sidang Proposal")
             ->setKeywords("Sidang Proposal");
...
$excel->setActiveSheetIndex(0)->setCellValue('A1', "JADWAL PESERTA SIDANG PROPOSAL"); // Set kolom A1 dengan tulisan "DATA SISWA"
...
$excel->setActiveSheetIndex(0)->setCellValue('I4', "PENGUJI 1"); // Set kolom F4 dengan tulisan "ALAMAT"
$excel->setActiveSheetIndex(0)->setCellValue('J4', "PENGUJI 2");
...
while($data = mysqli_fetch_array($sql)){ // Ambil semua data dari hasil eksekusi $sql
  ...
  $excel->setActiveSheetIndex(0)->setCellValue('I'.$numrow, $data['penguji1']);
  $excel->setActiveSheetIndex(0)->setCellValue('J'.$numrow, $data['penguji2']);
...
header('Content-Disposition: attachment; filename="Jadwalsidangproposal.xlsx"'); // Set nama file excel nya
