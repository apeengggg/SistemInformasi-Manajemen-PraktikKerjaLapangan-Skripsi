...
<head>
  ...
  <title>Data File Proposal | SIM-PS | Tata Usaha</title>
      ...
      <div class="col-12">
        <div class="card">
          <div class="card-header">
            ...
            <!-- <button class="btn-sm btn-info"><i class="fas fa-download"></i></button> -->
          </div>
          <!-- /.card-header -->
          <div class="card-body">
            <table id="example1" class="table table-bordered table-striped">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td><a href="detailfileprop.php?id=<?=$a?>"><?php echo $data1["judul"] ?><a></td>
