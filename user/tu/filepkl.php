...
<head>
  ...
  <title>Data File Laporan PKL | SIM-PS | Tata Usaha</title>
      ...
      <div class="col-12">
        <div class="card">
          <div class="card-header">
            <CENTER>
              <h1 class="m-0 text-dark">Data File Laporan PKL</h1>
            </CENTER>
          </div>
          <!-- /.card-header -->
          <div class="card-body">
            <table id="example1" class="table table-bordered table-striped">
              ...
              <tbody>
                <?php
                        ...
                        pkl.judul_laporan,
                        pkl.instansi,
                        pkl_file.filePKL, pkl_file.id_filePKL FROM mahasiswa  JOIN pkl 
                        ON mahasiswa.nim=pkl.nim  JOIN dosen_wali
                        ON pkl.id_dosenwali=dosen_wali.id_dosenwali  JOIN dosen
                        ON dosen_wali.nidn=dosen.nidn  JOIN pkl_file ON pkl.id_pkl=pkl_file.id_pkl")
                ...
                <tr>
                  ...
                  <td><a href="detailfilepkl.php?id=<?=$a?>"><?php echo $data1["judul_laporan"] ?></a></td>
                  <td><?php echo $data1["instansi"] ?></td>
                  <td align="center">
                    <a href="assets/downloadfile.php?filename=<?=$data1["filePKL"]?>" class="btn btn-info"><i
