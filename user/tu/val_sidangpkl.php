...
<head>
  ...
  <title>Validasi Pendaftaran Sidang PKL | SIM-PS | Tata Usaha</title>
            ...
            <table id="example1" class="table table-bordered table-striped">
              ...
              <tbody>
                <?php
                        ...
                        "SELECT m.nama, m.nim, pss.id_syarat, p.judul_laporan, d.nama_dosen, ps.id_sidpkl, ps.val_dosbing, pss.file
                        ...
                        LEFT JOIN dosen d
                        ON dw.nidn=d.nidn
                        LEFT JOIN pkl_syarat_sidang pss
                        ON ps.id_sidpkl=pss.id_sidang
                ...
                <tr>
                  ...
                  <td align="center"><a href="assets/downsidpkl.php?filename=<?= $data1["file"]?>"
            ...
            <table id="example3" class="table table-bordered table-striped">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td align="center"><a href="../../assets/syarat_sidang_pkl/<?= $data2["file"]?>"
                      class="btn btn-info"><i class="fas fa-download"></i></a></td>
                  <td align="center">
                    <button type="submit" id="detaildata1" class="btn btn-warning" data-toggle="modal"
                      ...
                      data-judul="<?php echo $data2["judul_laporan"] ?>"
