...
<html>
  <head>
    ...
    <title>Data File Proposal | SIM-PS | Penasihat Akademik</title>
            ...
            <div class="row">
              <div class="col-12">
                <div class="card">
                  ...
                  <center> <h1 class="m-0 text-dark" id="all">Data File Proposal</h1></center>
                    ...
                    <table id="example1" class="table table-bordered table-striped">
                      ...
                      <tbody>
                        ...
                        <td><?php echo $data1["nama"] ?></td>
                          ...
                          <td align="center"><a href="assets/downloadfileprop.php?filename=<?=$data1["file"]?>" class="btn btn-info"><i class="fas fa-download"></i></a></td>
                        </tr>
                        <?php  }
                        }
                        ?>
