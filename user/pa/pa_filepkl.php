...
<html>
  <head>
    ...
    <title>Data File Laporan PKL | SIM-PS | Penasihat Akademik</title>
          ...
          <section class="content">
            ...
            <div class="row">
              <div class="col-12">
                ...
                <center> <h1 class="m-0 text-dark">Data File Laporan PKL</h1></center></div>
                  <!-- /.card-header -->
                  <div class="card-body">
                    <table id="example1" class="table table-bordered table-striped">
                      <thead align="center">
                        <tr>
                          ...
                          <th width="80px">Pembimbing</th>
                          <th width="80px">Judul Laporan</th>
                          <th width="80px">Instansi</th>
                      ...
                      <tbody>
                        ...
                        <td><?php echo $data1["nama"] ?></td>
                          ...
                          <td align="center"><a href="assets/downloadfile.php?filename=<?=$data1["filePKL"]?>" class="btn btn-info"><i class="fas fa-download"></i></a></td>
                        </tr>
                        <?php  }
                        }
                        ?>
