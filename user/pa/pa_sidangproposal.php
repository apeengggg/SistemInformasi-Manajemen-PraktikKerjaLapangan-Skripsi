...
$jadwalsidang = mysqli_query($conn,
                        ...
                        WHERE pp.id_sidang=ps.id_sidang AND status_penguji='Penguji'
...
<html>
  <head>
    ...
    <title>Data Sidang Proposal | SIM-PS | Penasihat Akademik</title>
            ...
            <div class="row">
              <div class="col-12">
                <div class="card">
                  ...
                  <center><h1 class="m-0 text-dark" id="jad">Jadwal Pengujian Sidang Proposal</h1><br></center>
          ...
          <section class="content">
            <div class="row">
              <div class="col-12"> 
                <div class="card">
                <div class="card-header">
               <center> <h1 class="m-0 text-dark" id="all">Data Sidang Proposal Mahasiswa</h1><br></center>
