...
if ($penguji1==$penguji2) {
  ...
  windows.location.href('pendaftarsidangdraft.php') 
  </script>";
}else{ 
...
<html>
  <head>
    ...
    <title>Penjadwalan Sidang Draft | SIM-PS | Penasihat Akademik</title>
            ...
            <div class="row">
              <div class="col-12">
                <div class="card">
                  ...
                  <center> <h1 class="m-0 text-dark">Penjadwalan Sidang Draft</h1></center></div>
                  <!-- /.card-header -->
                  <div class="card-body">
                    <table id="example1" class="table table-bordered table-striped">
                      ...
                      <tbody>
                        ...
                        "SELECT mhs.nama,
                          ...
                          WHERE (sidang.val_dosbing1='2' AND sidang.val_dosbing2='2' ) 
