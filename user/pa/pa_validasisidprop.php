...
windows.location.href('validasisidprop.php')
</script>";
}else {
echo "<script>
...
<html>
  <head>
    ...
    <title>Validasi Pendaftar Sidang Proposal | SIM-PS | Penasihat Akademik</title>
            ...
            <div class="row">
              <div class="col-12">
                <div class="card">
                  ...
                  <center>
                  <h2 class="m-0 text-dark">Data Pendaftaran Sidang Proposal Mahasiswa Bimbingan</h2></center></div>
                  <!-- /.card-header -->
                  <div class="card-body">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                            ...
                            data-dosbing="<?php echo $data1["pembimbing"] ?>"
                            data-tgl="<?php echo $data1["tgl"] ?>"
                            data-penguji1="<?php echo $data1["penguji1"] ?>"
                            data-penguji2="<?php echo $data1["penguji2"] ?>"
                            data-ruang="<?php echo $data1["ruang_sid"] ?>"
                    ...
                    <table id="example3" class="table table-bordered table-striped">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                            <button type="submit" id="detaildata1" class="btn btn-warning" data-toggle="modal" data-target="#modal-lg1"
                            data-id="<?php echo $data2["id_sidang"] ?>"
                            data-nama="<?php echo $data2["nama"] ?>"
                            data-judul="<?php echo $data2["judul"] ?>"
                            data-dosbing="<?php echo $data2["pembimbing"] ?>"
                            data-tgl="<?php echo $data2["tgl"] ?>"
                            data-penguji1="<?php echo $data2["penguji1"] ?>"
                            data-penguji2="<?php echo $data2["penguji2"] ?>"
                            data-ruang="<?php echo $data2["ruang_sid"] ?>"
                            data-status="<?php echo $status ?>"><i class="fas fa-edit"></i></button>
                          </td>
                        </tr>
                        <?php  }
                          ...
                          <form class="form-horizontal" method="post">
                            <div class="card-body">
                              ...
                              <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                  <input type="text" class="form-control" id="id_dosenwali" name="id_dosenwali" required="required" readonly>
                                </div>
                              </div>
                              <div class="form-group row">
