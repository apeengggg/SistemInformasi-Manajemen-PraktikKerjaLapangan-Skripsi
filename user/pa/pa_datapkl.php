...
<html>
  <head>
    ...
    <title>Data Praktik Kerja Lapangan | SIM-PS | Penasihat Akademik</title>
            ...
            <div class="row">
              <div class="col-12">
                <div class="card">
                  ...
                  <center><h1 class="m-0 text-dark" id="all">Data PKL Mahasiswa</h1><br></center>
                    ...
                    <table id="example1" class="table table-bordered table-striped">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td align="center"><a href="assets/downloadsurat.php?filename=<?=$data1["surat_balasan"]?>" class="btn-sm btn-info">
