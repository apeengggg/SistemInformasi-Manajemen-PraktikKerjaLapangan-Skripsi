...
<html>
  <head>
    ...
    <title>Penjadwalan Sidang Proposal | SIM-PS | Penasihat Akademik</title>
            ...
            <div class="row">
              <div class="col-12">
                <div class="card">
                  ...
                  <center>
                  <h2 class="m-0 text-dark">Penjadwalan Sidang Proposal</h2></center></div>
                  <!-- /.card-header -->
                  <div class="card-body">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                            ...
                            data-idprop="<?php echo $data1["id_proposal"] ?>"
                            ...
                            <div class="card-body">
                              <div class="form-group row">
                                <div class="col-sm-9">
                                  ...
                                  <input type="text" class="form-control" id="id_proposal" name="id_proposal" required="required">
                                </div>
                              </div>
                              <div class="form-group row">
