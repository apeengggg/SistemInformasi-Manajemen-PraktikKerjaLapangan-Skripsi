...
<html>
  <head>
    ...
    <title>Data Sidang PKL | SIM-PS | Penasihat Akademik</title>
          ...
          <div class="col-sm-12">
            <!-- <h1 class="m-0 text-dark" id="jad">Jadwal Pengujian Sidang Hari Ini, <?=$date ?> </h1> -->
              ...
              <div class="col-12">
                ...
                <center><h1 class="m-0 text-dark" id="jad">Jadwal Pengujian Sidang</h1><br></center>
                  ...
                  <div class="card-body">
                    <table id="example1" class="table table-bordered table-striped">
                      ...
                      <tbody>
                        ...
                        WHERE pkl_sidang.status_sid IS NULL")
            ...
            <!-- <h1 class="m-0 text-dark" id="all">Data Sidang PKL</h1> -->
              ...
              <div class="col-12">
                <div class="card">
                  <div class="card-header">
                  <center>
                  <h1 class="m-0 text-dark" id="all">Data Sidang PKL</h1><br></center>
                  <!-- <button type="submit" class="btn btn-warning" data-toggle="modal" data-target="#modal-md"><i class="fas fa-print"> Cetak</i></button> -->
