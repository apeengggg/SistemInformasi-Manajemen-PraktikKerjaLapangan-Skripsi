...
<html>
  <head>
    ...
    <title>Data Sidang Draft | SIM-PS | Penasihat Akademik</title>
            ...
            <div class="row">
              <div class="col-12">
                <div class="card">
                  ...
                  <center> <h1 class="m-0 text-dark" id="penguji">Jadwal Sidang Draft</h1><br></center>
          ...
          <section class="content">
            <div class="row">
              <div class="col-12">
                <div class="card">
                  <div class="card-header">
                    <center><h1 class="m-0 text-dark" id="all">Data Sidang Draft Mahasiswa</h1><br></center>
