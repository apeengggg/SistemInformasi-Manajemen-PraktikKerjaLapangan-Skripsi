...
<html>
  <head>
    ...
    <title>Validasi Pendaftaran Sidang PKL | SIM-PS | Penasihat Akademik</title>
            ...
            <div class="row">
              <div class="col-12">
                <div class="card">
                  ...
                  <center> <h2 class="m-0 text-dark">Data Pendaftaran Sidang PKL Mahasiswa Bimbingan</h2></center></div>
                  <!-- /.card-header -->
                  <div class="card-body">
          ...
          <section class="content">
            <div class="row">
              <div class="col-12">
                <div class="card">
                  <div class="card-header">
                  <center> <h2 class="m-0 text-dark">Riwayat Validasi Pendaftaran Sidang</h2></center></div>
                  <!-- /.card-header -->
                  <div class="card-body">
                      ...
                      <tbody>
                        ...
                        <td align="center">
                          ...
                          <td align="center">
                            ...
                            data-id="<?php echo $data2["id_sidpkl"] ?>"
                            data-nama="<?php echo $data2["nama"] ?>"
                            data-judul="<?php echo $data2["judul_laporan"] ?>"
                            data-dosbing="<?php echo $data2["nama_dosen"] ?>"
                          ...
                          <form class="form-horizontal" method="post">
                            <div class="card-body">
                              <div class="form-group row">
                                <div class="col-sm-9">
                                  <input type="text" class="form-control" id="id_sidpkl" name="id_sidpkl" required="required" hidden readonly>
                                </div>
                              </div>
                              <div class="form-group row">
