            ...
            <div class="row">
              <div class="col-12">
                <div class="card">
                  ...
                  <center> <h1 class="m-0 text-dark" id="bim">Data File Skripsi Mahasiswa</h1><br></center>
                    ...
                    <table id="example3" class="table table-bordered table-striped">
                      ...
                      <tbody>
                        ...
                        <td><?php echo $data1["nama"] ?></td>
                          <td align="center"><a href="assets/downloadjurnalpdf.php?filename=<?=$data1["jurnal_pdf"]?>" class="btn-sm btn-info"><i class="fas fa-download"></i></a></td>
                        </tr>
                        <?php  }
                        }
                        ?>
