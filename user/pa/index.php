...
<html> 
  <head>
    ...
    <title>SIM-PS | Dashboard | PA</title>
                ...
                <div class="col-sm-2">
                  ...
                  <div class="col-sm-10">
                    ...
                    <a class="nav-link" data-widget="pushmenu" href="#"><i class="fas fa-bars"></i></a>
                      ...
                      <li class="breadcrumb-item active">Penasihat Akademik</li>
                      ...
                      <div class="col-lg-3 col-3">
                        ...
                        <div class="col-lg-3 col-3">
                          <div class="small-box bg-danger pend1">
                            <div class="inner">
                            <p>Daftar Sidang PKL :<?= $jadpkla ?></p>
                            <p>Daftar Sidang Prop :<?= $jadpropa ?></p>
                            </div>
                            <div class="icon">
                              <i class="ion ion-pie-graph"></i>
                            </div>
                          </div>
                          <div class="small-box bg-dark judul">
                            <div class="inner">
                            <p>Daftar Sidang Draft :<?= $jaddrafta ?></p>
                            <p>Daftar Sidang Pend :<?= $jadpenda ?></p>
                            </div>
                            <div class="icon">
