...
ON pkl.nim=mhs.nim
WHERE bim.nidn='$nidn'AND bim.status='Bimbingan Laporan' AND bim.nim='$decode' ORDER BY bim.tanggal ASC") or die (mysqli_erorr($conn));
      ...
      <div class="col-12">
        <div class="card">
          <div class="card-header">
            <center>
              <h3 class="m-0 text-dark">Data Bimbingan PKL,
                <?=$data1["nama"] ?></h3>
            </center>
          </div>
          <!-- /.card-header -->
    ...
    ?>
                <tr>
                  ...
                  <td align="center"><a href="assets/download.php?filename=<?= $data['filebim'] ?>"
                      class="btn-sm btn-primary"><i class="fas fa-file-download"></i></a></td>
                  <td align="center">
                    <?php
