...
windows.location.href='kp_verifikasidosbing.php'
</script>";    
  }else {
  $pem1 = $_POST["pem1"];
  $pem2 = $_POST["pem2"];
...
<head>
  ...
  <title>Verifikasi Dosbing 1 dan 2 | SIM-PS | Kaprodi</title>
      ...
      <div class="col-12">
        <div class="card">
          <div class="card-header">
            <center>
              <h1 class="m-0 text-dark">Pemilihan Dosen Pembimbing 1 dan 2 Skripsi</h1>
            </center>
          </div>
          <!-- /.card-header -->
          <div class="card-body">
            <table id="example1" class="table table-bordered table-striped">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td align="center">
                    <button class="btn btn-info" type="submit" name="verif" data-toggle="modal" id="verif"
                      data-target="#modal1" data-id_skripsi="<?= $data1["id_skripsi"]?>"
                      data-dosbing="<?=  $data1["nama_dosen"]?>" data-nama="<?=  $data1["nama"]?>"
                      data-nim="<?=  $data1["nim"]?>" data-judul="<?=  $data1["judul"]?>"
                      data-foto="<?=  $data1["foto"]?>" data-status="<?=  $data1["status_proposal"]?>">
              ...
              <div class="card-body">
                ...
                <div class="form-group row">
                  <div class="col-sm-12">
                    ...
                    <textarea name="judul" id="judul" cols="30" rows="2" class="form-control" required="required"
                      readonly></textarea>
                  </div>
                </div>
                <div class="form-group row">
                  ...
                  <div class="col-sm-4">
                    ...
                    <input type="text" class="form-control" id="stat_prop" name="stat_prop" required="required"
                      readonly>
                  </div>
                </div>
                <div class="form-group row">
