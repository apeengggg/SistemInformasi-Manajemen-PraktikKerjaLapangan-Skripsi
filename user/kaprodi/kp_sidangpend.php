...
$datasidang = mysqli_query($conn,
                        "SELECT DISTINCT mhs.nama, mhs.nim,
                          ...
                          (SELECT d1.nama_dosen FROM dosen d1 INNER JOIN pend_penguji ppe
                          ON d1.nidn=ppe.penguji 
                          WHERE ppe.id_sidang=ps.id_sidang AND ppe.status='Aktif' AND status_penguji='Penguji 1') AS penguji1, 
                          -- ambil data penguji2
                          (SELECT d2.nama_dosen FROM dosen d2 INNER JOIN pend_penguji ppe
                          ON d2.nidn=ppe.penguji 
                          WHERE ppe.id_sidang=ps.id_sidang AND ppe.status='Aktif' AND status_penguji='Penguji 2') as penguji2,
                          ps.tgl_sidang AS tgl,
                          ps.waktu_sidang AS waktu,
                          ps.ruang_sidang AS ruang, ps.id_sidang,
...
<head>
  ...
  <title>Data Sidang Pendadaran | SIM-PS | Kaprodi</title>
      ...
      <div class="col-12">
        <div class="card">
          <div class="card-header">
            <center>
              <h1 class="m-0 text-dark" id="penguji">Jadwal Pengujian Sidang Pendadaran</h1><br>
            </center>
    ...
    <div class="row">
      <div class="col-12">
        <div class="card">
          <div class="card-header">
            <center>
              <h1 class="m-0 text-dark" id="all">Data Sidang Pendadaran Mahasiswa</h1><br>
            </center>
