        ...
        <div class="card">
          ...
          <table align="center">
              ...
              <tr>
                ...
                <td>
                  <font size="4"><?= $data1["judul_laporan"] ?></font>
                </td>
              </tr>
              <tr>
                <td colspan="4">
      ...
      <div class="col-12">
        <div class="card">
          <div class="card-header">
            <center>
              <h3 class="m-0 text-dark">Detail File Laporan PKL</h3>
            </center>
          </div>
          <!-- /.card-header -->
          <div class="card-body">
            ...
            <embed src="../../assets/laporan_pkl/<?=$data1["filePKL"]?>" type="application/pdf" width="100%"
              height="500"></embed>
          </div>
          <!-- /.card-body -->
        </div>
