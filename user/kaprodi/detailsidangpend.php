...
ps.status_sidang AS status_sidang,
-- penguji 1
...
WHERE mhs.nim='$decode' ps.tgl_sidang IS NOT NULL ORDER BY ps.tgl_sidang DESC") 
...
<head>
  ...
  <title>Detail Sidang Pendadaran | SIM-PS</title>
    ...
    ?>
                <tr>
                  ...
                  <td align="center"> <button class="btn-xs btn-danger" data-toggle="modal" data-target="#modalnilai1"
                      id="nilai1" data-id="<?php echo $data["id_sidang"] ?>"
                      data-ids="<?php echo $data["id_skripsi"] ?>" data-dos1p1="<?php echo $data["dos1p1"] ?>"
                      data-dos1p11="<?php echo $data["dos1p11"] ?>" data-dos1sis="<?php echo $data["dos1sis"] ?>"
                      data-dos1ap="<?php echo $data["dos1ap"] ?>" data-dos2p1="<?php echo $data["dos2p1"] ?>"
                      data-dos2p11="<?php echo $data["dos2p11"] ?>" data-dos2sis="<?php echo $data["dos2sis"] ?>"
                      data-dos2ap="<?php echo $data["dos2ap"] ?>" data-peng1p1="<?php echo $data["peng1p1"] ?>"
                      data-peng1p11="<?php echo $data["peng1p11"] ?>" data-peng1sis="<?php echo $data["peng1sis"] ?>"
                      data-peng1ap="<?php echo $data["peng1ap"] ?>" data-peng2p1="<?php echo $data["peng2p1"] ?>"
                      data-peng2p11="<?php echo $data["peng2p11"] ?>" data-peng2sis="<?php echo $data["peng2sis"] ?>"
                      data-peng2ap="<?php echo $data["peng2ap"] ?>" data-status="<?php echo $data["status_sidang"] ?>"
                      ...
                      <div class="card-body">
                        ...
                        <div class="form-row">
                          <div class="form-group col-md-3">
                            ...
                            <input type="number" class="form-control" id="ap_penguji1" name="ap_penguji1" max="100"
                              min="0" readonly>
                          </div>
                          <div class="form-group col-md-3">
                            <label for="sistematika1">TanggungJawab Aplikasi Penguji2</label>
                            <input type="number" class="form-control" id="ap_penguji2" name="ap_penguji2" max="100"
                              min="0" readonly>
                          </div>
                          <div class="form-group col-md-3">
                        ...
                        <div class="form-row">
                          ...
                          <div class="form-group col-md-3">
                            ...
                            <input type="number" class="form-control" id="total" name="total" max="100" min="0"
                              readonly>
                          </div>
                          <div class="form-group col-md-3">
