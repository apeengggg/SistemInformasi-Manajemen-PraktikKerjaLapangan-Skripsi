...
<head>
  ...
  <title>Data Sidang Draft | SIM-PS | Kaprodi</title>
            ...
            <table id="example1" class="table table-bordered table-striped">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td align="center"><?php echo $tgl.'<br>'.$data1["waktu"] ?></td>
    ...
    <div class="row">
      <div class="col-12">
        <div class="card">
          <div class="card-header">
            <center>
              <h1 class="m-0 text-dark" id="all">Data Sidang Draft Mahasiswa</h1><br>
            </center>
