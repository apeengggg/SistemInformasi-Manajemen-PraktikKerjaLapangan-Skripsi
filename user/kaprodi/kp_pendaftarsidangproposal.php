...
windows.location.href('kp_pendaftarsidangproposal.php')
</script>";
}else {
...
<head>
  ...
  <title>Penjadwalan Sidang Proposal | SIM-PS | Kaprodi</title>
              ...
              <tbody>
                <?php
                        ...
                        "SELECT mhs.nama,
                          ...
                          AND sidang.status_sidang IS NULL AND pss.status='2' ") or die (mysqli_error($conn));
