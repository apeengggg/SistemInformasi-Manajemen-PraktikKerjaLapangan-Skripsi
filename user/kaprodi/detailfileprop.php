...
"SELECT mahasiswa.nama, mahasiswa.nim, mahasiswa.foto,
dosen.nama_dosen, 
judul.judul,
judul.studi_kasus,
proposal_file.file
...
WHERE proposal_file.id_file='$decode'") or die (mysqli_erorr($conn));
...
<head>
  ...
  <title>Detail File Laporan PKL | SIM-PS</title>
      ...
      <div class="col-12">
        <div class="card">
          ...
          <table align="center">
              ...
              <tr>
                <td>
                  <font size="4">NIM</font>
                </td>
                <td>
                  <font size="4">:</font>
                </td>
                <td>
                  <font size="4"><?= $data1["nim"] ?></font>
                </td>
              </tr>
              <tr>
                <td colspan="4">
              ...
              <tr>
                <td>
                  <font size="4">Pemb</font>
                </td>
                <td>
                  <font size="4">:</font>
                </td>
                <td>
                  <font size="4"><?= $data1["nama_dosen"] ?></font>
                </td>
              </tr>
              <tr>
                <td colspan="4">
      ...
      <div class="col-12">
        <div class="card">
          <div class="card-header">
            <center>
              <h3 class="m-0 text-dark">Detail File Proposal</h3>
            </center>
          </div>
          <!-- /.card-header -->
          <div class="card-body">
            ...
            <embed src="../../assets/proposal/<?=$data1["file"]?>" type="application/pdf" width="100%"
              height="500"></embed>
          </div>
          <!-- /.card-body -->
        </div>
