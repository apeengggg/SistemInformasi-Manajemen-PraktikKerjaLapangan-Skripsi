...
<head>
    ...
    <title>Validasi Pendaftar Sidang Pendadaran | SIM-PS | Kaprodi</title>
                              ...
                              ?>
                                ...
                                ?>
                                                <span class="badge badge-danger">
                                                    ...
                                                    <?= $val2  ?></td>
                                    <td align="center">
                                        <button type="submit" id="detaildata" class="btn-xs btn-warning"
                              ...
                              ?>
                                ...
                                ?>
                                                <span class="badge badge-danger">
                                                    ...
                                                    <?= $val2  ?></td>
                                    <td align="center">
                                        <button type="submit" id="detaildata1" class="btn-xs btn-warning"
                                            ...
                                            data-ruang="<?= $data2["ruang"] ?>" data-val1="<?= $val1 ?>"
                    ...
                    <form class="form-horizontal" method="post">
                        <div class="card-body">
                            <div class="form-group row">
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="id_sidang" name="id_sidang"
    ...
    <div class="modal fade" id="modal-lg1">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                    ...
                    <form class="form-horizontal" method="post">
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="validasi1" name="validasi1"
                                        required="required" readonly>
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="validasi2" name="validasi2"
                                        required="required" readonly>
                                </div>
                            </div>
                            <div class="form-group row">
                ...
                <div class="modal-footer justify-content-between">
                    <button type="button" class="btn btn-default" data-dismiss="modal">Tutup</button>
                    <button type="submit" class="btn btn-primary toastrDefaultSuccess" name="jadwalkan1"
                        id="jadwalkan1">Ubah Validasi</button>
                </div>
            </div>
            </form>
            <!-- /.modal-content -->
