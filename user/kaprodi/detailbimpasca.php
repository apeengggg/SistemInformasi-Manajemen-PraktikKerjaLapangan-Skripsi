...
// $getbim = mysqli_query($conn, "SELECT * FROM skripsi_bim WHERE pembimbing='$nidn' AND status='Bimbingan Pasca'") or die (mysqli_erorr($conn));
...
LEFT JOIN mahasiswa mhs
ON judul.nim=mhs.nim
WHERE bim.pembimbing='$nidn'AND ps.tgl_sidang IS NOT NULL AND bim.status='Bimbingan Pasca' AND bim.nim='$decode' ORDER BY bim.tgl_bim ASC") or die (mysqli_erorr($conn));
...
if (isset($_POST["ubahbim"])) {
  ...
  if (empty($filebim)) {
    ...
    if ($sql) {
      ...
      windows.location.href='detailbimpasca.php'
      </script>";
    }else {
      echo "<script>
  ...
  while ($data=mysqli_fetch_array($getdata)) {
    ...
    ?>
                <tr>
                  ...
                  <td align="center"><a href="assets/downloadbimpasca.php?filename=<?= $data['filebim'] ?>"
                  ...
                  <div class="modal-body">
                    ...
                    <form action="" method="post" enctype="multipart/form-data">
                      ...
                      <div class="form-row">
                        ...
                        <div class="form-group col-md-3">
                          <label for="lemrev">Lembar Revisi Pendadaran</label>
                          <br>
...
<script type="text/javascript">
  ...
  $(document).on("click", "#detaildata", function () {
    ...
    $("#modal-lg #lemrev").attr("href", "assets/downloadlemrevpend.php?filename=" + lemrev1);
  ...
  $(document).on("click", "#detaildata1", function () {
    ...
    $("#modal-lg1 #lemrev").attr("href", "assets/downloadlemrevpend.php?filename=" + lemrev1);
